    ...
    function () {
      ...
      _proto.create = function create() {
        ...
        if (this._config.close == true) {
          const newLocal = '<span aria-hidden="true">&times;</span>';
          var toast_close = $('<button data-dismiss="toast" />').attr('type', 'button').addClass('ml-2 mb-1 close').attr('aria-label', 'Close').append(newLocal);
